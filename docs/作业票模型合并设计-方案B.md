...
| 编制 | 高级项目经理 |
| 日期 | 2026-08-29 |
| 决策来源 | 用户确认：方案 B（常规+危险全落 `workPermits`，**彻底删除** `workPermitApplications` 表；系统未上线，无灰度/迁移/回滚）+ 先出详细设计 |
| 关联文档 | `作业票申请流程规范.md`、`作业票流程整体规划.html`、`作业票承包商协同改造-tasklist.md` |
| 当前状态 | **已实施完成**（后端 T1–T6 单表收口 + 前端收口 + 丢失端点补齐，均已合并推送） |
| 实施记录 | `56669a8` 彻底删除申请单表与模块；`eaacac7` 前端单表收口 + 作业票级现场检查；`d045655` 补回随模块误删的 12 个作业票级端点 |
